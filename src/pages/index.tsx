                ...
                <div className="grid h-full w-full grid-cols-12 gap-4">
                  <div className="col-span-8 flex flex-col space-y-2">
                    ...
                    <p className="break-words text-sm text-gray-500">
                      Lorem, ipsum dolor sit amet consectetur adipisicing elit.
                      Officiis laboriosam consectetur necessitatibus ad natus
                      blanditiis rerum vel dolore. Error libero id modi, magni
                      vitae voluptas ullam sed cupiditate praesentium
              ...
              {Array.from({ length: 4 }).map((_, i) => (
                <div key={i} className="flex items-center space-x-6">
                  ...
                  <div className="w-3/5 flex-col space-y-2">
                    ...
                    <div>
                      Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                      Dolorem debitis quo sapiente ea. Dolorum?{" "}
                    </div>
